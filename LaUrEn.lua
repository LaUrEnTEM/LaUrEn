...
--    This Is The Source Channel @LLNNTT .    --
--                 - LaUrEn -                  --
--         -- https://t.me/LLNNTT --          --
------------------------------------------------ 
redis = require('redis') 
...
NameBot = (DevAli:get(LaUrEn..'Ali:NameBot') or 'لورين')
--     Source LaUrEn     --
...
local UserName = (dp.username_ or "LLNNTT")
...
♪︙م6 ↫ اوامر الاعضاء
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
♪︙[Source Channel](https://t.me/LLNNTT)
]] 
keyboard = {} 
...
if text and text:match('^'..(DevAli:get(LaUrEn..'Ali:NameBot') or "لورين")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAli:get(LaUrEn..'Ali:NameBot') or "لورين")..' ','')
end
...
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'LLNNTT')..')'..' ❩\n♪︙تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
...
if mrali == "مميز" and VipMem(msg) then
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'LLNNTT')..')'..' ❩\n♪︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
local inline = {{{text="♪ المطور .",url="t.me/"..(dp.username_ or "LLNNTT")}}}
...
Dev_Ali(msg.sender_user_id_, msg.id_, 1, '♪︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "LLNNTT")..')', 1, 'md') 
...
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@LLNNTT]'))
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@LLNNTT]'))
Dev_Ali(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     Source LaUrEn     --
--        Contact         --
...
local BotName = (DevAli:get(LaUrEn.."Ali:NameBot") or 'لورين')
...
if text and text == (DevAli:get(LaUrEn..'Ali:NameBot') or 'لورين') then 
NameBot = (DevAli:get(LaUrEn..'Ali:NameBot') or 'لورين')
...
{{text = '˛ KٰaRٍiUsَ 🦅',url="t.me/Y_3_3"},{text = '𝗧𝗪𝗦 𝗟𝗔𝗨𝗥𝗘𝗡 ⁦ 🕷',url="https://t.me/T_LN_bot"}},{{text= '• Support Source • .',url="https://t.me/A_F_KU"}}
}
local msg_id = msg.id_/2097152/0.5
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id='..msg.chat_id_..'&photo=https://t.me/Y_3_3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source LaUrEn     --
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '♪ LaUrEn TeAM .',url="t.me/LLNNTT"}},
}
local msg_id = msg.id_/2097152/0.5
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/LLNNTT' end
...
ConstructorAli = "["..Ali.first_name_.."](T.me/"..(Ali.username_ or "LLNNTT")..")"
else 
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './LaUrEn.lua', '♪︙نسخة ملف سورس لورين',dl_cb, nil)
end end
--     Source LaUrEn     --
...
Dev_Ali(msg.chat_id_, msg.id_, 1, '♪︙Channel ↬ [@LLNNTT]', 1, 'md')    
end 
--     Source LaUrEn     --
if Sudo(msg) then 
