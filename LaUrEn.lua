...
{{text = '- ٌ𝆥 tِuِoٰfٌe ٰaٌِlٰHٰaٌِlfٍi ⤹',url="t.me/RFRFF"},{text = '• TWS SNAP 🦇',url="https://t.me/Y22fbot"}},{{text= '𝆥 𝙏𝙚𝙓𝙖𝙎.',url="https://t.me/YIY88Y"}}
}
local msg_id = msg.id_/2097152/0.5
...
--     Source LaUrEn     --
if text == "اهمس" or text == "همسه" or text == "اريد بوت الهمسه" or text == "دزلي بوت الهمسه" or  text == "دزولي بوت الهمسه" then  Dev_Ali(msg.chat_id_, msg.id_, 1, ' ⚘╽@YNNfboT', 1, 'md') end
...
Text = "• *The • - sَoٰuِِ𝖱ٰcٌe sَِ𝗇ٰaَpِ √ and programmer of this source is* : [KٰaRٍiUsَ ◞](https://t.me/RFRFF)."
keyboard = {} 
...
if not DevAbs:get(LaUrEn..'Abs:Mean:Abs'..msg.chat_id_) then
...
DevAbs:del(LaUrEn..'Abs:Audios:Abs'..msg.chat_id_) 
end
--     Source LaUrEn     --
if text == "تعطيل غنيلي" and Manager(msg) and ChCheck(msg) then
local SNAPTEAM = '⚘ ¦ اهلا عزيزي -› '..AbsRank(msg)..' \n⚘ ¦ تم تعطيل غنيلي بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, SNAPTEAM, 14, string.len(msg.sender_user_id_))
DevAbs:set(LaUrEn..'Abs:Audios:Abs'..msg.chat_id_,true)  
end
--     Source LaUrEn     --
